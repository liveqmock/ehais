...
@EPermissionController(intro="广告管理功能",value="haiAdController")
@Controller
@RequestMapping("/ehais")
public class  AdAdminController extends CommonController {

	private static Logger log = LoggerFactory.getLogger(AdAdminController.class);
	...
	@RequestMapping(value="/manage/haiAdListJson",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
	...
	@RequestMapping(value="/manage/haiAdAddDetail",method=RequestMethod.GET)
	...
	@RequestMapping(value="/manage/haiAdAddSubmit",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
	...
	@RequestMapping(value="/manage/haiAdEditDetail",method=RequestMethod.GET)
	...
	@RequestMapping(value="/manage/haiAdEditSubmit",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
	...
	@RequestMapping(value="/manage/haiAdDelete",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
	...
	@RequestMapping(value="/manage/haiAdPositionListJson",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
	...
	@RequestMapping(value="/manage/haiAdPositionAddDetail",method=RequestMethod.GET)
	...
	@RequestMapping(value="/manage/haiAdPositionAddSubmit",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
...
//			return "/"+this.getStoreTheme(request)+"/ad/adposition_detail";
	...
	@RequestMapping(value="/manage/haiAdPositionEditSubmit",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
	...
	@RequestMapping(value="/manage/haiAdPositionDelete",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
