...
@EPermissionController(intro="商户管理功能",value="storeAdminController")
@Controller
...
public class  HaiStoreAdminController extends EhaisCommonController {
	...
	@RequestMapping(value="/haiStoreDetail",method=RequestMethod.GET)
	...
	@RequestMapping(value="/haiStoreSubmit",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
