...
@EPermissionController(intro="商品信息功能",value="goodsAdminController")
@Controller
...
public class  GoodsAdminController extends EhaisCommonController {
	...
	@RequestMapping(value="/ehaisGoodsListJson",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
	...
	@RequestMapping(value="/ehaisGoodsAddDetail",method=RequestMethod.GET)
	...
	@RequestMapping(value="/ehaisGoodsAddSubmit",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
	...
	@RequestMapping(value="/ehaisGoodsEditDetail",method=RequestMethod.GET)
	...
	@RequestMapping(value="/ehaisGoodsEditSubmit",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
	...
	@RequestMapping(value="/ehaisGoodsDelete",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
	...
	@RequestMapping(value="/ehaisCategoryListJson",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
	...
	@RequestMapping(value="/ehaisCategoryAddSubmit",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
	...
	@RequestMapping(value="/ehaisCategoryEditDetail",method=RequestMethod.POST)
	...
	@RequestMapping(value="/ehaisCategoryEditSubmit",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
	...
	@RequestMapping(value="/ehaisCategoryDelete",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
	...
	@RequestMapping(value="/goods_qrcode",method=RequestMethod.POST)
