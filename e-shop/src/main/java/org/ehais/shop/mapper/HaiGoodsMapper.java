...
public interface HaiGoodsMapper {
     ...
     */
    @Select("select * from hai_goods where goods_id = ${goods_id} and store_id = ${store_id} ")
    @ResultMap(value = "ResultMapWithBLOBs") //BaseResultMap  ResultMapWithBLOBs
    HaiGoodsWithBLOBs get_hai_goods_info_v2(@Param("goods_id") Long goods_id, @Param("store_id") Integer store_id);
