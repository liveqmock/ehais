...
//	public ReturnObject<HaiCart> cart_info_session(HttpServletRequest request,Long recId,String sessioin_id) throws Exception;
	public ReturnObject<HaiCartWithBLOBs> cart_add_submit(HttpServletRequest request,Long goods_id,Integer store_id,Integer quantity,Long user_id,String session_shop_encode) throws Exception;
