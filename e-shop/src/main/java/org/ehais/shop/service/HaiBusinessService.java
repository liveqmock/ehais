...
public interface HaiBusinessService extends CommonService{
	...
	public ReturnObject<HaiBusinessWithBLOBs> business_insert_submit(HttpServletRequest request,HaiBusinessWithBLOBs model) throws Exception;
	public ReturnObject<HaiBusinessWithBLOBs> business_update(HttpServletRequest request,Integer businessId) throws Exception;
	public ReturnObject<HaiBusinessWithBLOBs> business_update_submit(HttpServletRequest request,HaiBusinessWithBLOBs model) throws Exception;
