...
public interface HaiPaymentService extends CommonService{
	...
	public ReturnObject<HaiPayment> payment_update(HttpServletRequest request,Integer paymentId) throws Exception;
	public ReturnObject<HaiPayment> payment_update_submit(HttpServletRequest request,HaiPayment model) throws Exception;
	public ReturnObject<HaiPayment> payment_info(HttpServletRequest request,Integer paymentId) throws Exception;
	public ReturnObject<HaiPayment> payment_find(HttpServletRequest request,Integer paymentId) throws Exception;
	public ReturnObject<HaiPayment> payment_delete(HttpServletRequest request,Integer paymentId) throws Exception;
