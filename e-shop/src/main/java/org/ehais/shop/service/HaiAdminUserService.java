...
public interface HaiAdminUserService extends CommonService{
	...
	public ReturnObject<EHaiAdminUserWithBLOBs> adminuser_insert_submit(HttpServletRequest request,EHaiAdminUserWithBLOBs model) throws Exception;
	public ReturnObject<EHaiAdminUserWithBLOBs> adminuser_update(HttpServletRequest request,Long adminId) throws Exception;
	public ReturnObject<EHaiAdminUserWithBLOBs> adminuser_update_submit(HttpServletRequest request,EHaiAdminUserWithBLOBs model) throws Exception;
