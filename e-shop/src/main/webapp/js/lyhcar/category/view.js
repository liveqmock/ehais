...
$(function(){
    ...
    $("#btnSearch").click(function(){catName = $.trim($("#catName").val());bsTable.bootstrapTable('refresh', { query : {keySubId : keySubId , catName : catName , page : 1} });});
    
    bsTable = $('#bsTable').bootstrapTable({
    	contentType: "application/x-www-form-urlencoded",
        url: 'haiCategoryListJson',//请求后台的url
        method: 'post',//请求方式
        ...
        uniqueId: 'catId',//每一行的唯一标识，一般为主键列
        columns: [
    ...
    title: '排序'
...

        {
            ...
            formatter : function(value,row,index){
				var opt = "";
            	opt += "<a href ='getHaiCategoryEditDetail?catId="+value+"'  class='glyphicon glyphicon-edit'></a>";
            	opt += "&nbsp;&nbsp;<a href ='javascript:;' onclick='haiCategoryDelete("+value+");' class='glyphicon glyphicon-trash'></a>";
            	return opt;
            }
        }
