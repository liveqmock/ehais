...
$(function(){
    ...
    $("#btnSearch").click(function(){employeeName = $.trim($("#employeeName").val());bsTable.bootstrapTable('refresh', { query : {keySubId : keySubId , employeeName : employeeName , page : 1} });});
    
    bsTable = $('#bsTable').bootstrapTable({
    	contentType: "application/x-www-form-urlencoded",
        url: 'haiEmployeeListJson',//请求后台的url
        method: 'post',//请求方式
    ...
    title: '手机号码'
...

        {
            ...
            formatter : function(value,row,index){
				var opt = "";
            	opt += "<a href ='haiEmployeeEditDetail?employeeId="+value+"'  class='glyphicon glyphicon-edit'></a>";
            	opt += "&nbsp;&nbsp;<a href ='javascript:;' onclick='haiEmployeeDelete("+value+");' class='glyphicon glyphicon-trash'></a>";
            	return opt;
            }
        }
