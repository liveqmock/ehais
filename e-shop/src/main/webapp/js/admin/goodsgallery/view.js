...
$(function(){
    ...
    $("#btnSearch").click(function(){tableName = $.trim($("#tableName").val());bsTable.bootstrapTable('refresh', { query : {keySubId : keySubId , tableName : tableName , page : 1} });});
    
    bsTable = $('#bsTable').bootstrapTable({
    	contentType: "application/x-www-form-urlencoded",
        url: 'haiGoodsGalleryListJson',//请求后台的url
        method: 'post',//请求方式
...

        {
            ...
            formatter : function(value,row,index){
				var opt = "";
            	opt += "<a href ='haiGoodsGalleryEditDetail?imgId="+value+"'  class='glyphicon glyphicon-edit'></a>";
