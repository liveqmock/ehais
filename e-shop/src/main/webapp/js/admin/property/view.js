...
$(function(){
    ...
    $("#btnSearch").click(function(){propertyName = $.trim($("#propertyName").val());bsTable.bootstrapTable('refresh', { query : {keySubId : keySubId , propertyName : propertyName , page : 1} });});
    
    bsTable = $('#bsTable').bootstrapTable({
    	contentType: "application/x-www-form-urlencoded",
        url: 'haiPropertyListJson',//请求后台的url
        method: 'post',//请求方式
        ...
        uniqueId: 'propertyId',//每一行的唯一标识，一般为主键列
        columns: [
    ...
    title: '名称'
...

        {
            ...
            formatter : function(value,row,index){
				var opt = "";
            	opt += "<a href ='haiPropertyEditDetail?propertyId="+value+"'  class='glyphicon glyphicon-edit'></a>";
            	opt += "&nbsp;&nbsp;<a href ='javascript:;' onclick='haiPropertyDelete("+value+");' class='glyphicon glyphicon-trash'></a>";
            	return opt;
            }
        }
