...
$(function(){
    ...
    $("#btnSearch").click(function(){expensesName = $.trim($("#expensesName").val());bsTable.bootstrapTable('refresh', { query : {keySubId : keySubId , expensesName : expensesName , page : 1} });});
    
    bsTable = $('#bsTable').bootstrapTable({
    	contentType: "application/x-www-form-urlencoded",
        url: 'haiExpensesListJson',//请求后台的url
        method: 'post',//请求方式
        ...
        uniqueId: 'expensesId',//每一行的唯一标识，一般为主键列
        columns: [
    ...
    title: '名称'
...

        {
            ...
            formatter : function(value,row,index){
				var opt = "";
            	opt += "<a href ='haiExpensesEditDetail?expensesId="+value+"'  class='glyphicon glyphicon-edit'></a>";
            	opt += "&nbsp;&nbsp;<a href ='javascript:;' onclick='haiExpensesDelete("+value+");' class='glyphicon glyphicon-trash'></a>";
            	return opt;
            }
        }
