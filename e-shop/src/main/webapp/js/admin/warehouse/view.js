...
$(function(){
    ...
    $("#btnSearch").click(function(){warehouseName = $.trim($("#warehouseName").val());bsTable.bootstrapTable('refresh', { query : {keySubId : keySubId , warehouseName : warehouseName , page : 1} });});
    
    bsTable = $('#bsTable').bootstrapTable({
    	contentType: "application/x-www-form-urlencoded",
        url: 'haiWarehouseListJson',//请求后台的url
        method: 'post',//请求方式
    ...
    title: '名称'
...

        {
            ...
            formatter : function(value,row,index){
				var opt = "";
            	opt += "<a href ='haiWarehouseEditDetail?warehouseId="+value+"'  class='glyphicon glyphicon-edit'></a>";
            	opt += "&nbsp;&nbsp;<a href ='javascript:;' onclick='haiWarehouseDelete("+value+");' class='glyphicon glyphicon-trash'></a>";
            	return opt;
            }
        }
