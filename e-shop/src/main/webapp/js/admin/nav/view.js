    ...
    title: '图片'
...

        {
            ...
            formatter : function(value,row,index){
            	var a = "<a href ='haiNavEditDetail?id="+value+"'  class='glyphicon glyphicon-pencil'></a>";
            	var b = "&nbsp;&nbsp;<a href ='javascript:;' onclick='haiNavDelete("+value+");' class='glyphicon glyphicon-trash'></a>";
            	return a+b;
            }
        }
