...
$(function(){
    ...
    bsTable = $('#bsTable').bootstrapTable({
        ...
        url: 'haiWithdrawDepositListJson',//请求后台的url
        method: 'post',//请求方式
...

{
    ...
    field: 'withdrawDeposit',
    title: 'withdraw_deposit'
},{
    field: 'isSuccess',
    title: 'is_success'
},{
    ...
    title: 'return_message'
...

        {
            ...
            formatter : function(value,row,index){
            	var a = "<a href ='haiWithdrawDepositEditDetail?wdId="+value+"'  class='glyphicon glyphicon-pencil'></a>";
            	var b = "&nbsp;&nbsp;<a href ='javascript:;' onclick='haiWithdrawDepositDelete("+value+");' class='glyphicon glyphicon-trash'></a>";
            	return a+b;
            }
        }
...
function haiWithdrawDepositDelete(wdId){
	layer.confirm('您确定要删除此项吗？',{
		btn: ['确定删除','不删除'] //按钮
	}, function(){
		$.ajax({
			url : "haiWithdrawDepositDelete",type:"post",dataType:"json",data:{wdId:wdId},
