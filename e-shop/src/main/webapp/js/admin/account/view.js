...
$(function(){
    ...
    $("#btnSearch").click(function(){accountName = $.trim($("#accountName").val());bsTable.bootstrapTable('refresh', { query : {keySubId : keySubId , accountName : accountName , page : 1} });});
    
    bsTable = $('#bsTable').bootstrapTable({
    	contentType: "application/x-www-form-urlencoded",
        url: 'haiAccountListJson',//请求后台的url
        method: 'post',//请求方式
    ...
    title: '名称'
...

        {
            ...
            formatter : function(value,row,index){
				var opt = "";
            	opt += "<a href ='haiAccountEditDetail?accountId="+value+"'  class='glyphicon glyphicon-edit'></a>";
            	opt += "&nbsp;&nbsp;<a href ='javascript:;' onclick='haiAccountDelete("+value+");' class='glyphicon glyphicon-trash'></a>";
            	return opt;
            }
        }
