...
$(function(){
    ...
    $("#btnSearch").click(function(){businessName = $.trim($("#businessName").val());bsTable.bootstrapTable('refresh', { query : {keySubId : keySubId , businessName : businessName , page : 1} });});
    
    bsTable = $('#bsTable').bootstrapTable({
    	contentType: "application/x-www-form-urlencoded",
        url: 'haiBusinessListJson',//请求后台的url
        method: 'post',//请求方式
    ...
    title: '企业名称'
...

        {
            ...
            formatter : function(value,row,index){
				var opt = "";
            	opt += "<a href ='haiBusinessEditDetail?businessId="+value+"'  class='glyphicon glyphicon-edit'></a>";
            	opt += "&nbsp;&nbsp;<a href ='javascript:;' onclick='haiBusinessDelete("+value+");' class='glyphicon glyphicon-trash'></a>";
            	return opt;
            }
        }
