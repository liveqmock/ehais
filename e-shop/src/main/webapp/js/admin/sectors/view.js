...
$(function(){
    ...
    $("#btnSearch").click(function(){sectorsName = $.trim($("#sectorsName").val());bsTable.bootstrapTable('refresh', { query : {keySubId : keySubId , sectorsName : sectorsName , page : 1} });});
    
    bsTable = $('#bsTable').bootstrapTable({
    	contentType: "application/x-www-form-urlencoded",
        url: 'haiSectorsListJson',//请求后台的url
        method: 'post',//请求方式
        ...
        uniqueId: 'sectorsId',//每一行的唯一标识，一般为主键列
        columns: [
...

        {
            ...
            formatter : function(value,row,index){
				var opt = "";
            	opt += "<a href ='haiSectorsEditDetail?sectorsId="+value+"'  class='glyphicon glyphicon-edit'></a>";
            	opt += "&nbsp;&nbsp;<a href ='javascript:;' onclick='haiSectorsDelete("+value+");' class='glyphicon glyphicon-trash'></a>";
            	return opt;
            }
        }
