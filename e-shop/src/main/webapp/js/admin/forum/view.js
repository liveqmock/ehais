    ...
    title: '回复某评论的上级ID'
...

        {
            ...
            formatter : function(value,row,index){
            	var a = "<a href ='haiForumEditDetail?forumId="+value+"'  class='glyphicon glyphicon-pencil'></a>";
            	var b = "&nbsp;&nbsp;<a href ='javascript:;' onclick='haiForumDelete("+value+");' class='glyphicon glyphicon-trash'></a>";
            	return a+b;
            }
        }
