...
$(function(){
    ...
    $("#btnSearch").click(function(){unitName = $.trim($("#unitName").val());bsTable.bootstrapTable('refresh', { query : {keySubId : keySubId , unitName : unitName , page : 1} });});
    
    bsTable = $('#bsTable').bootstrapTable({
    	contentType: "application/x-www-form-urlencoded",
        url: 'haiUnitListJson',//请求后台的url
        method: 'post',//请求方式
        ...
        uniqueId: 'unitId',//每一行的唯一标识，一般为主键列
        columns: [
    ...
    title: '名称'
...

        {
            ...
            formatter : function(value,row,index){
				var opt = "";
            	opt += "<a href ='haiUnitEditDetail?unitId="+value+"'  class='glyphicon glyphicon-edit'></a>";
            	opt += "&nbsp;&nbsp;<a href ='javascript:;' onclick='haiUnitDelete("+value+");' class='glyphicon glyphicon-trash'></a>";
            	return opt;
            }
        }
