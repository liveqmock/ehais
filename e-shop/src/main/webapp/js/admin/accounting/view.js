...
$(function(){
    ...
    $("#btnSearch").click(function(){accountingName = $.trim($("#accountingName").val());bsTable.bootstrapTable('refresh', { query : {keySubId : keySubId , accountingName : accountingName , page : 1} });});
    
    bsTable = $('#bsTable').bootstrapTable({
    	contentType: "application/x-www-form-urlencoded",
        url: 'haiAccountingListJson',//请求后台的url
        method: 'post',//请求方式
        ...
        uniqueId: 'accountingId',//每一行的唯一标识，一般为主键列
        columns: [
    ...
    title: '名称'
...

        {
            ...
            formatter : function(value,row,index){
				var opt = "";
            	opt += "<a href ='haiAccountingEditDetail?accountingId="+value+"'  class='glyphicon glyphicon-edit'></a>";
            	opt += "&nbsp;&nbsp;<a href ='javascript:;' onclick='haiAccountingDelete("+value+");' class='glyphicon glyphicon-trash'></a>";
            	return opt;
            }
        }
		...
		success : function(result){
		    ...
		    $('#tree').treeview({
		        ...
		        onNodeSelected: function (event, data) {
		        	...
		        	$("#accountingName").val("");accountingName = "";
