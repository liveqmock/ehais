...
$(function(){
    ...
    $("#btnSearch").click(function(){incomeName = $.trim($("#incomeName").val());bsTable.bootstrapTable('refresh', { query : {keySubId : keySubId , incomeName : incomeName , page : 1} });});
    
    bsTable = $('#bsTable').bootstrapTable({
    	contentType: "application/x-www-form-urlencoded",
        url: 'haiIncomeListJson',//请求后台的url
        method: 'post',//请求方式
        ...
        uniqueId: 'incomeId',//每一行的唯一标识，一般为主键列
        columns: [
    ...
    title: '名称'
...

        {
            ...
            formatter : function(value,row,index){
				var opt = "";
            	opt += "<a href ='haiIncomeEditDetail?incomeId="+value+"'  class='glyphicon glyphicon-edit'></a>";
            	opt += "&nbsp;&nbsp;<a href ='javascript:;' onclick='haiIncomeDelete("+value+");' class='glyphicon glyphicon-trash'></a>";
            	return opt;
            }
        }
