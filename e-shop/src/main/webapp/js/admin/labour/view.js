...
$(function(){
    ...
    $("#btnSearch").click(function(){labourName = $.trim($("#labourName").val());bsTable.bootstrapTable('refresh', { query : {keySubId : keySubId , labourName : labourName , page : 1} });});
    
    bsTable = $('#bsTable').bootstrapTable({
    	contentType: "application/x-www-form-urlencoded",
        url: 'haiLabourListJson',//请求后台的url
        method: 'post',//请求方式
        ...
        uniqueId: 'labourId',//每一行的唯一标识，一般为主键列
        columns: [
    ...
    title: '名称'
...

        {
            ...
            formatter : function(value,row,index){
				var opt = "";
            	opt += "<a href ='haiLabourEditDetail?labourId="+value+"'  class='glyphicon glyphicon-edit'></a>";
            	opt += "&nbsp;&nbsp;<a href ='javascript:;' onclick='haiLabourDelete("+value+");' class='glyphicon glyphicon-trash'></a>";
            	return opt;
            }
        }
