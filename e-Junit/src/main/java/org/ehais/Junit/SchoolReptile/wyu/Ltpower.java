...
public class Ltpower extends ArticleCommonReptile{

	private static String website = "http://demo.ltpower.net";
	public static String store_id = "5003";
	public static String cat_name = "";
	public static String articleSource = "电子商务";
...
//    }
	...
	@Test
	public void tnews(){
		String url = "http://demo.ltpower.net/web/fzdnhh/news/show-4304.html";
		this.newsinfo(url, "", "");
	}
...
//    		System.out.println(doc.html());
    		Element param = doc.getElementsByClass("right-main-show").first();
    		System.out.println(param.outerHtml());
    		
//    		Element flashvars = doc.getElementsByTag("");
//    		Elements table = doc.getElementsByTag("table");
